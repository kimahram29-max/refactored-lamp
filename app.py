...
# ==========================================
# 🔒 [구글 계정 연동] 오류 메시지 기반 정확한 매개변수 주입
# ==========================================
...
# 에러 로그 분석 반영: 필수 positional argument인 redirect_uri를 명시적으로 주입
authenticator = Authenticate(
    ...
    redirect_uri=st.secrets["google_auth"]["redirect_uri"]  # 여기에 필수 인자 명시적 추가
)
